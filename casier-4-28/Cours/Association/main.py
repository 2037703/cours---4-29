...
# Importer le popup_cours

from popup_cours import *
##########################################################
...
class fenetrePrincipale(QtWidgets.QMainWindow, interfaceMain2.Ui_MainWindow):
    """
    ...
    #Boutton ouvrir cours
    @pyqtSlot()
    def on_pushButton_cours_open_clicked(self):
        """
        Méthode du bouton cours pour ouvrir la fenêtre de dialogue popupcours
        """
